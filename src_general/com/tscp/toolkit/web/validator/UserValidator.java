 ...
 // private UserManager userManager;
  ...
  public void validate(Object target, Errors errors) {
    ...
    if("updatePassword".equalsIgnoreCase(user.getAction())) {
    	...
    	validatePassword(user.getNewPassword(), errors);	
    }
    else if("resetPassword".equalsIgnoreCase(user.getAction())){
    	validatePassword(user.getPassword(), errors);
    }
    else if("updateUsernameAndEmail".equalsIgnoreCase(user.getAction())){
    	validateEmail(user.getNewEmail(), errors);
    }
