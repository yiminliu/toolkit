   ...
   <div>
       ...
       <form:errors path="*" cssClass="error" />
         ...
         <fieldset>        
           ...
           <tr>
              <th><form:label path="password" cssClass="required">Current Password</form:label></th>
              <td><form:input path="password" cssClass="span-8" cssErrorClass="span-8 validationFailed" /></td>
           </tr> 
           <tr>
              <th><form:label path="newPassword" cssClass="required">New Password</form:label></th>
              <td><form:input path="newPassword" cssClass="span-8" cssErrorClass="span-8 validationFailed" /></td>
           </tr> 
           <tr>
              <th></th>
              <!-- <a id="updatePasswordCouponButton" href="#" class="button action-m centerFloats"><span>Submit</span></a>--> 
              <td><input id="updatePasswordSubmit" type="submit" name="_eventId_submit" value="Submit" class="hidden" /></td>
          </tr>     
          <form:hidden path="action" value="updatePassword" />     
          </table>
        </fieldset> 
     </form:form>   
</body>
